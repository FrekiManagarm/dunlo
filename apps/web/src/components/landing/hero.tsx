  ...
  return (
    <section className="relative flex min-h-svh flex-col items-center justify-center overflow-hidden px-6 py-32">
      ...
      <div className="relative z-10 mx-auto flex max-w-4xl flex-col items-center text-center">
        <div
          className="l-stagger mb-8 inline-flex items-center gap-2 border border-landing-border bg-landing-surface/60 px-4 py-1.5 text-xs tracking-[0.2em] font-medium text-landing-text-secondary uppercase backdrop-blur-sm"
